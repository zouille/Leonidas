...
*/
      ...
      if (!self.ispage || (!cap.cantouch && !cap.isieold && !cap.isie9mobile)) {
        ...
        cursor.append('<div class="ascrailScrollInner"><span class="top"></span><span class="bottom"></span></div>');
        cursor.css({
        ...
        var innreRail = $(document.createElement('div'));
        rail.append(innreRail);
        rail.attr('id',self.id);
        rail.attr('class','ascrailScroll');
        innreRail.attr('class','ascrailScrollRail');
        innreRail.append('<span class="top"></span><span class="bottom"></span>');
...
// init HORIZ
        ...
        if (self.opt.horizrailenabled) {
          ...
          var cursor = $(document.createElement('div'));
          cursor.append('<div class="ascrailScrollInner"><span class="left"></span><span class="right"></span></div>');
          cursor.css({
          ...
          var innreRailh = $(document.createElement('div'));
          railh.append(innreRailh);
          railh.attr('id',self.id+'-hr');
          railh.attr('class','ascrailScroll-hr');
          innreRailh.attr('class','ascrailScrollRail');
          innreRailh.append('<span class="left"></span><span class="right"></span>');
